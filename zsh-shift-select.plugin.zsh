...
function {
	...
	for	kcap   seq          seq_mac    widget (             # key name
		...
		x      '^[[1;6D'   	x          beginning-of-line    # Shift + Ctrl + LeftArrow
		kEND   '^[[1;2F'    x          end-of-line          # Shift + End
		x      '^[[1;6C'  	x          end-of-line          # Shift + Ctrl + RightArrow
		x      '^[[1;4D'    x		   backward-word        # Shift + Alt + LeftArrow
		x      '^[[1;4C'    x  		   forward-word         # Shift + Alt + RightArrow
